...
parser.add_argument(
    ...
    default="/work/gleckler1/processed_data/clim_plots")
parser.add_argument(
    "--models-directory",
    help="models directory",
    default="/work/gleckler1/processed_data/metrics_package/interpolated_model_clims_historical/global")
...
opathin = os.path.join(
    ...
    'OBS',
    'ac',
    'VAR_OBS_000001-000012_ac.nc')

# MOD path
mpathin = os.path.join(
    args.models_directory,
    'cmip5.MOD.historical.r1i1p1.mo.Amon.VAR.ver-1.1980-2005.interpolated.linear.2.5x2.5.global.AC.nc')
